...
export const SKILL_DESCRIPTION =
	"Manage tasks in the configured tasks-axi backend - add, list, show, start, " +
	"and complete tasks; track blocked-by dependencies, structured holds, and a " +
	"ready queue. Use whenever a task touches backlog or task state: filing or " +
	"dispatching work, recording a PR or report on completion, or finding " +
	"dispatchable or held work.";
